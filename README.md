...
Gleaming is an interactive 3D web project built with Next.js, React, Three.js, and React Three Fiber.

It also includes a Python API built with FastAPI, PostgreSQL for data storage, and WebSocket for real-time communication.
